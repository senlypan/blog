...
- 并发编程
- 多线程
preview: https://www.panshenlian.com/images/post/java/concurrency/multithreading/title.jpg
introduce: |
...
![translation-004-java-concurrency-and-multithreading-tutorial.md#title.jpg](https://www.panshenlian.com/images/post/java/concurrency/multithreading/title.jpg)
...
![00-java-concurrency#introduction-1.png](https://www.panshenlian.com/images/post/java/concurrency/tutorial/introduction-1.png)


但是，线程不等同于CPU，通常单个CPU在多个线程之间执行时间是共享的，只不过CPU在每个线程获得一定执行时间片之后运行切换。当然，同一个应用程序中的不同线程也可以让不同的CPU来执行。

![00-java-concurrency#introduction-2.png](https://www.panshenlian.com/images/post/java/concurrency/tutorial/introduction-2.png)
...
![00-java-concurrency#java-concurrency-tutorial-introduction-1.png](https://www.panshenlian.com/images/post/java/concurrency/tutorial/java-concurrency-tutorial-introduction-1.png)
