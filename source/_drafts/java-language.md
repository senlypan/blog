...
关于 Java 语言，[IBM](https://developer.ibm.com/languages/java/) <sup>[1]</sup> 官网的描述是：
...
Java 语言不因 JVM 而自命不凡，不因 Go 而患得患失，也从来不是效率高的语言，从 1995 年发布的 1.0 版本开始，截止目前为止， Java 版本已经是 [Java17](https://www.oracle.com/news/announcement/oracle-releases-java-17-2021-09-14/) <sup>[6] </sup> ，从最初的 Oak 夹缝求生，到如今拥有这么庞大的开源社区支持，以及海量高质量的组件支持，使得 Java 语言在互联网/企业应用、Android 移动平台以及大数据平台领域都占据一定优势，一路来除了商业爸爸的支持，主要得益自身能够不断快速进化，被开发者接受、被市场所接受。
